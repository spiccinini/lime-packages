...
describe('LiMe Config tests', function()
    ...
    it('test config.uci_gen_auto standard config', function()
    ...
    it('test config.uci_gen_auto missing node', function()
    ...
    it('test config.uci_gen_auto missing network', function()
